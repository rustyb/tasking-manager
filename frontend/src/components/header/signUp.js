...
class SignUp extends Component {
  ...
  onSubmit = (e) => {
    ...
    registerPromise.then(res => {
      ...
      if (res.success === true) {
        setTimeout(() => window.location.href = 'https://www.openstreetmap.org/user/new', 2000);
      }
    })
  }
  ...
  render() {
    return (
      <div style={signUpStyle}>
        ...
        <p style={paragraphStyle}>You will be redirected to the OpenStreetMap website, where you need to
